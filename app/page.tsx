      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-16 text-center">
        <div className="max-w-3xl mx-auto space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-50">
            Generate Smart Tier Lists with AI
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Create beautiful, insightful tier lists for any topic in seconds. Let AI do the heavy lifting while you
            focus on what matters.
          </p>
          <div className="pt-4">
            <Link href="/create">
              <Button size="lg" className="h-12 px-8 text-base bg-[#3b82f6] hover:bg-[#2563eb]">
                Start Building a Tier List
              </Button>
            </Link>
          </div>
          <div className="pt-12 pb-8">
            <div className="relative mx-auto max-w-3xl rounded-lg overflow-hidden shadow-lg">
              <img src="/placeholder.svg?height=600&width=1200" alt="Tier list example" className="w-full h-auto" />
