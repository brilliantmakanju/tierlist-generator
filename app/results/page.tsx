        ...
        if (data.success && data.data) {
          ...
          try {
            if (typeof data.data.content === 'string') {
              ...
              jsonContent = data.data.content as unknown as TierListDataInterface;
            }
            
            
            // Update state with the parsed tier list data
            ...
            setError("Failed to parse the generated tier list. Please try again.");
            throw parseError;
          }
        } else {
